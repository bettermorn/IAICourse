...
稼动率（Operating Rate / 可动率）稼动率是衡量**设备实际运转时间占计划工作时间比例**的指标，只关注"设备有没有在动"，不考虑速度快慚或产出质量好坏。
...
OEE（Overall Equipment Effectiveness，设备综合效率） OEE 是更全面的指标，由三个维度相乘构成，同时衡量**时间利用率、速度效率、质量合格率**：
